package com.omdasoft.orderonline.gwt.order.client.core.view.constant;
...
public abstract class ViewConstants {
	...
	public static final int per_page_number_in_entry = 10;
	public static final int per_page_number_in_front = 5;
