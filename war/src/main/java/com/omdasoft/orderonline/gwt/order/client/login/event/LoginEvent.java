package com.omdasoft.orderonline.gwt.order.client.login.event;
...
public class LoginEvent extends GwtEvent<LoginHandler> {
	...
	public static enum LoginStatus {
		LOGIN_OK, LOGIN_FAILED, LOGOUT, LOGIN_EXPIRED,LOGIN_OK_STAFF,LOGIN_OK_GIFT,LOGIN_OK_DEPT,LOGIN_OK_AWARD,LOGIN_OK_NOMINATE,RELOGOUT,LOGIN_OK_PLATFORM_ADMIN
	}
