 ...
 */
public class ImageLinkCell extends AbstractSafeHtmlCell<String> {

	/**
	 * Construct a new ButtonCell that will use a {@link SimpleSafeHtmlRenderer}
	 * .
	 */
	public ImageLinkCell() {
	 ...
	 */
	public ImageLinkCell(SafeHtmlRenderer<String> renderer) {
	 ...
	 @Override
	  ...
	  public void render(Context context, SafeHtml data, SafeHtmlBuilder sb) {
		  sb.appendHtmlConstant("<img src='"+data+"' >");
