 ...
 */
public class SelectHyperLinkCell extends AbstractSafeHtmlCell<String> {

	/**
	 * Construct a new ButtonCell that will use a {@link SimpleSafeHtmlRenderer}
	 * .
	 */
	public SelectHyperLinkCell() {
	 ...
	 */
	public SelectHyperLinkCell(SafeHtmlRenderer<String> renderer) {
