package com.omdasoft.orderonline.gwt.order.client.frontOrderList.dataprovider;
...
public class FrontOrderListViewAdapter extends BaseDataProvider<OrderListClient> {

	final DispatchAsync dispatch;
	final FrontOrderListDisplay display;
	OrderListCriteria criteria;
	final ErrorHandler errorHandler;
	final SessionManager sessionManager;

	public FrontOrderListViewAdapter(DispatchAsync dispatch,
			OrderListCriteria criteria, ErrorHandler errorHandler,
			SessionManager sessionManager, FrontOrderListDisplay display) {
