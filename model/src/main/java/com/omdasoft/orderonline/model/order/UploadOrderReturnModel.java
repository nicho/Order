...
@XmlRootElement
public class UploadOrderReturnModel implements Serializable {
	/**
	 * 
	 */
	...
	private List<UploadOrderModel> data;
	...
	public List<UploadOrderModel> getData() {
		return data;
	}
	public void setData(List<UploadOrderModel> data) {
		this.data = data;
	}
