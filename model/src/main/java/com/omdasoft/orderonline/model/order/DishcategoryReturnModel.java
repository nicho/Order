...
@XmlRootElement
public class DishcategoryReturnModel implements Serializable {
	/**
	 * 
	 */
	...
	private List<DishesTypeModel> data;
	...
	public List<DishesTypeModel> getData() {
		return data;
	}
	public void setData(List<DishesTypeModel> data) {
		this.data = data;
	}
